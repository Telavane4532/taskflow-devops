...
AI_FEATURE_FLAGS = {
    "summarize": env_bool("AI_FEATURE_SUMMARIZE", True),
    "prioritize": env_bool("AI_FEATURE_PRIORITIZE", True),
    "parse": env_bool("AI_FEATURE_PARSE", True),
    "similar": env_bool("AI_FEATURE_SIMILAR", True),
}
